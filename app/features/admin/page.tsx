  ...
  return (
    <div className="space-y-6">
      {/* <section
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(190,155,164,0.08), rgba(50,30,34,0.02))",
          border: "1px solid rgba(255,255,255,0.03)",
        }}
      >
        <h1 className="text-2xl font-semibold" style={{ color: "#f4e7e8" }}>
          Admin Features
        </h1>
        <p className="text-slate-300 mt-2">
          Flow: Authentication → Create Admin → Admin Login → Admin Dashboard.
        </p>
      </section> */}
